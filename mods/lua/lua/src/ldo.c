/*
** $Id: ldo.c,v 1.2 2005/07/03 20:34:30 sskjaeret Exp $
...
static LUACFUNC void resume (lua_State *L, void *ud) {
  StkId firstResult;
...
static LUACFUNC void f_parser (lua_State *L, void *ud) {
  int i;
  Proto *tf;
  Closure *cl;
