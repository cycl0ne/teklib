/*
** $Id: lstate.c,v 1.1 2005/05/08 19:15:45 tmueller Exp $
** Global State
...
*/
static LUACFUNC void f_luaopen (lua_State *L, void *ud) {
  global_State *g = G(L);
  UNUSED(ud);
...
lua_State *luaE_newthread (lua_State *L) {
  ...
  #if defined(TEKLIB)
  *LUABASE(L1) = *LUABASE(L); /* copy user state */
  #endif
...
static LUACFUNC void callallgcTM (lua_State *L, void *ud) {
  UNUSED(ud);
