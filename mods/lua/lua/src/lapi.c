/*
** $Id: lapi.c,v 1.1 2005/05/08 19:15:45 tmueller Exp $
** Lua API
...
static LUACFUNC Table *getcurrenv (lua_State *L) {
...
static LUACFUNC void f_call (lua_State *L, void *ud) {
...
static LUACFUNC void f_Ccall (lua_State *L, void *ud) {
