...
/*
**	$Id: hal.c,v 1.5 2005/09/13 02:42:16 tmueller Exp $
**	teklib/mods/hal/posix/hal.c - Darwin implementation of the HAL layer
**
**	Written by Timm S. Mueller <tmueller at neoscientists.org>
**	and Michael Taubert <mtaubert at neoscientists.org>
...
LOCAL TAPTR
hal_allocself(TUINT size)
{
	return malloc(size);
}

LOCAL TVOID
hal_freeself(TAPTR mem, TUINT size)
{
	return free(mem);
}
	...
	TUINT sigmask)
{
	TUINT sig;
	TTIME tt = *wt;
	tt.ttm_USec *= 1000;	/* timespec expects nanoseconds */
	...
	for (;;)
	{
		...
		if (pthread_cond_timedwait(&t->hpt_SigCond,
			&t->hpt_SigMutex, (struct timespec *) &tt) == ETIMEDOUT) break;
	}
...
**	
**	Revision 1.4  2004/09/09 19:34:35  tmueller
...
**	
**	Revision 1.2  2004/01/13 02:17:55  tmueller
**	Cosmetic: Header and footer updated
**	
**	Revision 1.1  2004/01/10 13:05:40  mtaubert
**	Sorry, but I've forgot the hal module the last time. :-)
**
